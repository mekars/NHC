...
file_connectivity = open(os.path.join(sys.path[0],'Data_connectivity.txt'), 'r'$
...
file_network = open(os.path.join(sys.path[0],'Data_network.txt'), 'r')
...
file_pathway = open(os.path.join(sys.path[0],'Data_pathway.txt'), 'r')
...
file_GO_BP = open(os.path.join(sys.path[0],'Data_GO_BP.txt'), 'r')
file_GO_BP.readline()
GO_BP_size = 0
GO_BP_genes = set()
...
file_GO_MF = open(os.path.join(sys.path[0],'Data_GO_MF.txt'), 'r')
file_GO_MF.readline()
GO_MF_size = 0
GO_MF_genes = set()
